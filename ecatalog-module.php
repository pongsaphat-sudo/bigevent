...
function store_ecatalog_pdf(string $field, ?string $current): ?string
{
    ...
    if ((int) ($file['size'] ?? 0) > 50 * 1024 * 1024) {
        throw new RuntimeException('ไฟล์ PDF ต้องมีขนาดไม่เกิน 50 MB');
    }
